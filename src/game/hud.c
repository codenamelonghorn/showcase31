...
void render_hud_mario_lives(void) {
    ...
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(61), HUD_TOP_Y, "%d", gHudDisplay.lives);
}
...
void render_hud_timer(void) {
    ...
    switch (eu_get_language()) {
        case LANGUAGE_ENGLISH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(180), 185, "TIME");
            break;
        case LANGUAGE_FRENCH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(185), 185, "TEMPS");
            break;
        case LANGUAGE_GERMAN:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(180), 185, "ZEIT");
            break;
    }
#endif
...
#endif
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(103), 185 - 165, "%02d", timerMins);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(71), 185 - 165, "%02d", timerSecs);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(37), 185 - 165, "%d", timerFracSecs);
