...
const MacroObject hmc_seg7_macro_objs[] = {
    ...
    MACRO_OBJECT(/*preset*/ macro_box_metal_cap,               /*yaw*/   0, /*pos*/  -6430, 2400,  6357),
    ...
    MACRO_OBJECT(/*preset*/ macro_scuttlebug_spawner,          /*yaw*/ 360, /*pos*/ -6520,  1390,  2985),
    MACRO_OBJECT(/*preset*/ macro_swoop,                       /*yaw*/   0, /*pos*/ -6290,  2890,  5790),
